...
//   setMapModal(false);
//   navigation.navigate("MapPicker", {
//     returnData: { title, price, contact, location, state, district, subDistrict, category, propertyPreference, propertySize, propertyUnit, bedrooms, bathrooms, kitchen, buildingDetails, interior, construction, landmark, images },
//   });
// };

// // ✅ Update existing useFocusEffect
// useFocusEffect(
//   useCallback(() => {
//     // Restore location
//     if (route?.params?.selectedLocation) {
...
//     const data = route?.params?.returnData;
//     if (data) {
//       setTitle(data.title || "");
//       setPrice(data.price || "");
//       setContact(data.contact || "");
