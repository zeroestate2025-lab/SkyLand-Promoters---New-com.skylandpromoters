...
// import BottomNav from "../../components/ReusableComponents/BottomNav";
// import AnimatedBackground from "../../components/ReusableComponents/AnimatedBackground";
// import GlobalText from "../../theme/GlobalText"; // ✅ unified app font
...
//           <GlobalText style={styles.optionText}>{item.title}</GlobalText>
...
//       >
//         <View style={styles.modalOverlay}>
//           <Animatable.View animation="zoomIn" style={styles.modalBox}>
//             <LogOut size={40} color="#E53935" />
//             <GlobalText bold style={styles.modalTitle}>
//               Confirm Logout
//             </GlobalText>
//             <GlobalText style={styles.modalMessage}>
//               Are you sure you want to log out?
//             </GlobalText>
