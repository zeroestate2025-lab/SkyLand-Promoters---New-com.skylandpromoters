...
//   // ✅ ALL Animation References declared at top
//   const rentCardScale = useRef(new Animated.Value(0.8)).current;
//   const rentCardOpacity = useRef(new Animated.Value(0)).current;
//   const saleCardScale = useRef(new Animated.Value(0.8)).current;
//   const saleCardOpacity = useRef(new Animated.Value(0)).current;
//   const rentIconRotate = useRef(new Animated.Value(0)).current;
//   const saleIconRotate = useRef(new Animated.Value(0)).current;
//   const headerSlide = useRef(new Animated.Value(50)).current;
//   const headerOpacity = useRef(new Animated.Value(0)).current;
//   const rentCardSkew = useRef(new Animated.Value(0)).current;
//   const saleCardSkew = useRef(new Animated.Value(0)).current;
//   const rentPulse = useRef(new Animated.Value(1)).current;
//   const salePulse = useRef(new Animated.Value(1)).current;
//   const bgGlow = useRef(new Animated.Value(0)).current;
//   const dividerWidth = useRef(new Animated.Value(0)).current;
//   const titleSlide = useRef(new Animated.Value(-50)).current;
//   const titleOpacity = useRef(new Animated.Value(0)).current;
...
//   // ✅ Animation function declared OUTSIDE of render
//   const startAnimations = () => {
//     // Title slide animation
//     Animated.sequence([
//       Animated.delay(0),
...
//     // Sale card animation with skew
//     Animated.sequence([
//       Animated.delay(500),
//       Animated.parallel([
//         Animated.timing(saleCardScale, {
//           toValue: 1,
//           duration: 600,
//           useNativeDriver: true,
//         }),
//         Animated.timing(saleCardOpacity, {
//           toValue: 1,
//           duration: 600,
//           useNativeDriver: true,
//         }),
//         Animated.timing(saleCardSkew, {
//           toValue: 1,
//           duration: 600,
//           useNativeDriver: false,
//         }),
...
//     Animated.loop(
//       Animated.timing(saleIconRotate, {
//         toValue: 1,
//         duration: 6000,
//         useNativeDriver: true,
//       })
...
//   const saleIconRotateInterpolate = saleIconRotate.interpolate({
//     inputRange: [0, 1],
//     outputRange: ["0deg", "-360deg"],
//   });
...
//   const saleSkewInterpolate = saleCardSkew.interpolate({
//     inputRange: [0, 1],
//     outputRange: ["-8deg", "0deg"],
//   });
...
//         {/* Cards Container - Smaller and Compact */}
//         <View style={styles.cardsContainer}>
//           {/* Rent Card */}
//           <Animated.View
//             style={[
...
//               {
//                 transform: [
//                   { scale: Animated.multiply(saleCardScale, salePulse) },
//                   { perspective: 1000 },
//                 ],
//                 opacity: saleCardOpacity,
//               },
//             ]}
//           >
//             <Animated.View
...
//                 styles.cardTransform,
//                 {
//                   transform: [{ skewY: saleSkewInterpolate }],
//                 },
//               ]}
//             >
//               <Animatable.View
...
//                       styles.iconCircleWrapper,
//                       {
//                         transform: [{ rotate: saleIconRotateInterpolate }],
//                       },
//                     ]}
//                   >
//                     <LinearGradient
...
//   // ✅ NEW: Cards Container for side-by-side layout
//   cardsContainer: {
//     flexDirection: "row",
//     justifyContent: "center",
//     alignItems: "center",
...
// //           iterationCount="infinite"
// //           duration={3000}
// //           style={[styles.bgCircle1, { backgroundColor: `${COLORS.primary}10` }]}
// //         />
// //         <Animatable.View
// //           animation="pulse"
// //           iterationCount="infinite"
// //           duration={4000}
// //           delay={500}
// //           style={[styles.bgCircle2, { backgroundColor: `${COLORS.secondary}10` }]}
// //         />
...
// //                   style={styles.iconCircle}
// //                 >
// //                   <Icon name="home-city" size={48} color={COLORS.white} />
// //                 </LinearGradient>
// //               </Animated.View>
...
// //                   <GlobalText style={styles.bulletText}>
// //                     Affordable options
// //                   </GlobalText>
// //                 </View>
// //                 <View style={styles.bulletContainer}>
...
// //                   style={[styles.cardSubtitle, { color: subtitleColor }]}
// //                 >
// //                   Discover your dream home for sale
// //                 </GlobalText>
...
// //     left: -50,
// //   },
// //   cardWrapper: { width: "100%", marginVertical: 12 },
// //   card: {
// //     borderWidth: 1.5,
// //     borderRadius: 18,
// //     paddingVertical: 20,
...
// //     shadowOffset: { width: 0, height: 4 },
// //   },
// //   cardTouchable: { alignItems: "center", justifyContent: "center" },
...
// //     shadowOffset: { width: 0, height: 3 },
// //   },
// //   cardContent: { alignItems: "center", marginBottom: 15 },
// //   cardTitle: { fontSize: 20, fontWeight: "700", marginBottom: 6, letterSpacing: 0.3 },
// //   cardSubtitle: { fontSize: 13, textAlign: "center", marginBottom: 12, fontWeight: "400" },
// //   bulletContainer: { flexDirection: "row", alignItems: "center", marginVertical: 5, paddingHorizontal: 10 },
// //   bulletPoint: { width: 6, height: 6, borderRadius: 3, backgroundColor: COLORS.primary, marginRight: 10 },
// //   bulletText: { fontSize: 12, color: "#666666", fontWeight: "500" },
// //   arrowIcon: { marginTop: 10 },
// //   divider: { width: "60%", height: 1, backgroundColor: "#DDD", marginVertical: 10 },
// // });
...
// // //       >
// // //         <TouchableOpacity
// // //           style={[styles.card, { backgroundColor: cardColor, borderColor: accentColor }]}
// // //           onPress={() => handleSelect("Rent")}
// // //           activeOpacity={0.8}
// // //         >
// // //           <LinearGradient
...
// // //             style={styles.iconCircle}
// // //           >
// // //             <Icon name="home-city" size={45} color="#fff" />
// // //           </LinearGradient>
// // //           <GlobalText bold style={[styles.cardTitle, { color: textColor }]}>
// // //             Rent
// // //           </GlobalText>
// // //           <GlobalText style={[styles.cardSubtitle, { color: subtitleColor }]}>
...
// // //   cardSubtitle: { fontSize: 14, marginTop: 5, textAlign: "center" },
// // // });
...
// // // // //           onPress={() => handleSelect("Rent")}
// // // // //         >
// // // // //           <Icon name="home-city" size={45} color="#f5c518" />
// // // // //           <Text style={styles.cardTitle}>Rent</Text>
// // // // //           <Text style={styles.cardSubtitle}>Explore rental properties</Text>
// // // // //         </TouchableOpacity>
...
// // // // //           onPress={() => handleSelect("Sale")}
// // // // //         >
// // // // //           <Icon name="home" size={45} color="#f5c518" />
// // // // //           <Text style={styles.cardTitle}>Sale</Text>
// // // // //           <Text style={styles.cardSubtitle}>Discover properties for sale</Text>
// // // // //         </TouchableOpacity>
// // // // //       </View>
// // // // //     </ImageBackground>
// // // // //   );
